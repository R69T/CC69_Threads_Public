...
感謝大家不厭其煩地協助測試 CC69，也謝謝大家持續回報實際使用時遇到的問題。

CC69 目前已針對已知問題進行修正，包含：

- **大型帳號在粉絲數、追蹤數很多時，快速檢查可能取得不完全的問題。**
- **資料取得不完整後，程式可能長時間沒有動作、看起來像卡住的問題。**
- **大型 Followers / Following 清單在尾端無法完整取得時，程式無法繼續整理的問題。**

目前最新版本已針對以上狀況進行調整與修正。我們仍需要更多不同帳號、不同規模的實際測試資料來持續改善穩定性。

**懇請大家再給 CC69 一些機會，多多使用、測試並回報遇到的問題。每一份反饋都會幫助我們繼續把 CC69 做得更穩定。謝謝大家。**

---

## ✨ CC69 功能介紹

<p align="center"><img src="assets/CN%20PROM.png" alt="CC69 Threads Manager 功能介紹" width="100%"></p>
