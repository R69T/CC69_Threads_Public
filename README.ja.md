...
## 📢 最新修正のお知らせ｜2026-09-03

何度も根気よく CC69 をテストしてくださっている皆さま、そして実際の使用中に見つかった問題を継続して報告してくださっている皆さま、本当にありがとうございます。

CC69 では現在、以下の既知の問題を修正しました。

- **大規模アカウントで、フォロワー数・フォロー数が多い場合にクイックスキャンの取得結果が不完全になる問題。**
- **関係データを完全に取得できなかった後、アプリが長時間動かないように見えたり、停止したように見える問題。**
- **大規模な Followers / Following リストの末尾を完全に取得できない場合、整理作業を続けられなくなる問題。**

最新バージョンでは、これらの状況を対象に調整と修正を行っています。今後さらに安定性を高めるため、規模の異なるさまざまなアカウントでの実使用テストがまだ必要です。

**どうか CC69 にもう一度チャンスをいただき、引き続き使って、テストして、問題があればフィードバックをお寄せください。皆さまからの一つひとつの報告が、CC69 をより安定したものにする助けになります。ありがとうございます。**
